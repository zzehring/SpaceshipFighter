...
public class GameManager extends GameCore {
    ...
    static final Logger log = Logger.getLogger("tilegame");
    ...
    public void init() {
        ...
        gameStateManager = new GameStateManager(inputManager,
            resourceManager.loadImage("loadingsplash1.jpg"));
        gameStateManager.addState(new MainGameState(
            soundManager, midiPlayer,
            screen.getWidth(), screen.getHeight()));
        gameStateManager.addState(
            new SplashGameState("startScreen2.jpg", midiPlayer, soundManager));
        gameStateManager.addState(
            new InstructionGameState("instructionsScreen.jpg", soundManager));
        gameStateManager.addState(
        	new FinishedGameState("victoryScreen.jpg", midiPlayer, soundManager));
