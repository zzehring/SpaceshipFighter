...
public abstract class PowerUp extends Sprite {
    ...
    /**
        A Star PowerUp. Gives the player a shield.
    */
    public static class Shield extends PowerUp {
        public Shield(Animation anim) {
            super(anim);
        }
    }
    ...
    */
    ...
    public static class Stop extends PowerUp {
    	public Stop(Animation anim) {
    		super(anim);
    	}
    }
